...
def add_artikel(nama_jurnal, nama_artikel, nama_penulis, tahun_publikasi, link_artikel):
    conn = connect_to_db()
    cursor = conn.cursor()
    
    query = "INSERT INTO artikel (nama_jurnal, nama_artikel, nama_penulis, tahun_publikasi, link_artikel) VALUES (%s, %s, %s, %s, %s)"
    cursor.execute(query, (nama_jurnal, nama_artikel, nama_penulis, tahun_publikasi, link_artikel))
    conn.commit()
...
def update_artikel(nama_jurnal, nama_artikel, nama_penulis, tahun_publikasi, link_artikel, id_artikel):
    conn = connect_to_db()
    cursor = conn.cursor()
    
    query = "UPDATE artikel SET nama_jurnal = %s, nama_artikel = %s, nama_penulis = %s, tahun_publikasi = %s, link_artikel = %s WHERE id_artikel= %s"

    cursor.execute(query, (nama_jurnal, nama_artikel, nama_penulis, tahun_publikasi, link_artikel,id_artikel))
...
def add_analisa_hasil(id_analisa, id_pasien, id_penyakit, tanggal_analisa, gejala_gejala):
    conn = connect_to_db()
    cursor = conn.cursor()
